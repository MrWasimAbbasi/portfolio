  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Wasim | Waseem | Developer | Certified | VueJs | Laravel | Yii | React | M. Wasim Abbasi | GraphQL | REST.' },
        { hid: 'og:title', property: 'og:title', content: siteTitle },
        { hid: 'og:description', property: 'og:description', content: 'A professional & certified full-stack developer.' },
